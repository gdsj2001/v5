...
static const V5MicrokernelManifestEntry k_manifest[] = {
    {"linuxcnc_ini", "linuxcnc/ini/v5_pulse.ini", V5_MICROKERNEL_MANIFEST_FILE, 1, "microkernel"},
    {"linuxcnc_hal", "linuxcnc/hal/v5_pulse.hal", V5_MICROKERNEL_MANIFEST_FILE, 1, "microkernel"},
    ...
    {"parameter_file", "linuxcnc/runtime/parameters.var", V5_MICROKERNEL_MANIFEST_RUNTIME_OWNER, 1, "microkernel"},
    {"tool_table", "linuxcnc/runtime/tool.tbl", V5_MICROKERNEL_MANIFEST_RUNTIME_OWNER, 1, "microkernel"},
