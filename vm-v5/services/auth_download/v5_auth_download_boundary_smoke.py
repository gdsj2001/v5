...
AUTH_DOWNLOAD_FILES = (
    Path("services/auth_download/device_auth_latch.py"),
    Path("services/auth_download/v5_device_authorization_download.py"),
    Path("services/auth_download/v5_drive_profile_download.py"),
    Path("services/auth_download/drive_profile_download_flow.py"),
)
