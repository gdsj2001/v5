...
def parse_args(argv: Optional[List[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument("--out-root", default=os.environ.get("RE_V5_DRIVE_PROFILE_ROOT", os.environ.get("AX8_DRIVE_PROFILE_ROOT", DEFAULT_OUT_ROOT)))
    parser.add_argument("--device-dna", default="")
    parser.add_argument("--token", default="")
    parser.add_argument("--token-file", default=os.environ.get("RE_V5_DRIVE_PROFILE_TOKEN_FILE", os.environ.get("AX8_DRIVE_PROFILE_TOKEN_FILE", DEFAULT_TOKEN_FILE)))
    ...
    parser.add_argument("--private-mode", choices=("auto", "always", "skip"), default=os.environ.get("RE_V5_DRIVE_PROFILE_PRIVATE_MODE", os.environ.get("AX8_DRIVE_PROFILE_PRIVATE_MODE", "auto")))
    parser.add_argument("--timeout", type=float, default=float(os.environ.get("RE_V5_DRIVE_PROFILE_DOWNLOAD_TIMEOUT", os.environ.get("AX8_DRIVE_PROFILE_DOWNLOAD_TIMEOUT", "20"))))
