...
# Route-driven closure for the small step_ip setup margin.
...
append_timing_history $timing_history_csv $build_status $timing_status $timing_dict $path_dict $impl_status $bit_file
