...
static const V5ParameterField kV5ParameterFields[] = {
    ...
    {"motion_model", V5_PARAMETER_OWNER_KINEMATICS_NATIVE, V5_PARAMETER_READBACK_NATIVE_API, 1, 1, 0},
    ...
    {"axis_*_egear_numerator", V5_PARAMETER_OWNER_DRIVE_ONLY, V5_PARAMETER_READBACK_DRIVE_PROVIDER, 0, 0, 1},
    {"axis_*_egear_denominator", V5_PARAMETER_OWNER_DRIVE_ONLY, V5_PARAMETER_READBACK_DRIVE_PROVIDER, 0, 0, 1},
    {"axis_*_write_status", V5_PARAMETER_OWNER_DRIVE_ONLY, V5_PARAMETER_READBACK_DRIVE_PROVIDER, 0, 0, 1},
