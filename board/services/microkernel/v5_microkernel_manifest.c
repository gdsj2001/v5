...
static const V5MicrokernelManifestEntry k_manifest[] = {
    ...
    {"g53_geometry_parameter_memory", "linuxcnc/src/hal/user_comps/v5_native_hal_owner.comp", V5_MICROKERNEL_MANIFEST_RUNTIME_OWNER, 1, "native_hal_owner"},
    {"native_safety_latch_owner", "linuxcnc/src/hal/components/v5_safety_latch.comp", V5_MICROKERNEL_MANIFEST_RUNTIME_OWNER, 1, "native_safety"},
    {"native_rtcp_control_owner", "linuxcnc/src/hal/user_comps/v5_native_hal_owner.comp", V5_MICROKERNEL_MANIFEST_NATIVE_API, 1, "native_rtcp_control"},
