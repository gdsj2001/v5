...
static const V5NativeStatusEntry k_status_entries[] = {
    ...
    {"rotary_logical_abs_counts", V5_NATIVE_STATUS_ROTARY_WINDOW, "hal/native/motion.v5-wcheckpoint-{a,b,c}-logical-counts", 0},
    {"rotary_wcheckpoint_base_counts", V5_NATIVE_STATUS_ROTARY_WINDOW, "hal/native/motion.v5-wcheckpoint-{a,b,c}-base-counts", 0},
    {"rotary_runtime_window_counts", V5_NATIVE_STATUS_ROTARY_WINDOW, "hal/native/motion.v5-wcheckpoint-{a,b,c}-runtime-counts", 0},
    {"rotary_raw_count_bits", V5_NATIVE_STATUS_ROTARY_WINDOW, "hal/native/motion.v5-wcheckpoint-{a,b,c}-raw-count-bits", 0},
    {"rotary_logical_storage_bits", V5_NATIVE_STATUS_ROTARY_WINDOW, "hal/native/motion.v5-wcheckpoint-{a,b,c}-logical-storage-bits", 0},
    {"rotary_generation", V5_NATIVE_STATUS_ROTARY_WINDOW, "hal/native/motion.v5-wcheckpoint-{a,b,c}-generation", 0},
    {"rotary_invalid_reason", V5_NATIVE_STATUS_ROTARY_WINDOW, "hal/native/motion.v5-wcheckpoint-{a,b,c}-invalid-reason", 0},
    {"rotary_wcheckpoint_valid", V5_NATIVE_STATUS_ROTARY_WINDOW, "hal/native/motion.v5-wcheckpoint-{a,b,c}-valid", 0},
