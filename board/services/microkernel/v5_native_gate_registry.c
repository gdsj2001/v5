...
static const V5NativeGateEntry k_gates[] = {
    ...
    {"rtcp_set", V5_NATIVE_GATE_GEOMETRY, "native_linuxcncrsh", "Set Mode MDI | Set MDI M128/M129"},
    {"estop_force", V5_NATIVE_GATE_SAFETY, "native_safety", "Set Machine Off"},
    {"estop_reset", V5_NATIVE_GATE_SAFETY, "native_safety", "Set EStop Off | Get Estop | Set Machine On | Get Machine"},
