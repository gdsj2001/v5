...
from drive_profile_download_cache import invalidate_private_active_mapping, remove_retired_effective_cache, remove_private_cache
...
def run(args: argparse.Namespace, job_token: Any = None) -> Dict[str, Any]:
    ...
    retired_effective_removed = remove_retired_effective_cache(root)
    token = args.token or os.environ.get("RE_V5_DRIVE_PROFILE_TOKEN", "") or read_text_token(args.token_file)
    ...
    try:
        ...
        report = {
            ...
            "out_root": str(root),
            "retired_effective_removed": retired_effective_removed,
        }
