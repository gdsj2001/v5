...
def refresh_device_auth_latch_from_local_authorization(
    *,
    ...
    args = SimpleNamespace(
        device_auth_file=str(device_auth_file or os.environ.get("RE_V5_DEVICE_AUTH_FILE", DEFAULT_DEVICE_AUTH_FILE)),
        device_auth_public_key_file=str(device_auth_public_key_file or os.environ.get("RE_V5_DEVICE_AUTH_PUBLIC_KEY_FILE", DEFAULT_DEVICE_AUTH_PUBLIC_KEY_FILE)),
        device_private_key_file=str(device_private_key_file or os.environ.get("RE_V5_DEVICE_PRIVATE_KEY_FILE", DEFAULT_DEVICE_PRIVATE_KEY_FILE)),
        device_public_key_file=str(device_public_key_file or os.environ.get("RE_V5_DEVICE_PUBLIC_KEY_FILE", DEFAULT_DEVICE_PUBLIC_KEY_FILE)),
    )
    try:
