...
typedef struct V5ProgramSceneProducer {
    ...
    V5StatusPoint base_points[V5_STATUS_SCENE_POINT_COUNT];
    V5ProgramSceneWorldSegment base_segments[V5_STATUS_SCENE_SEGMENT_COUNT];
    V5ProgramSceneWorldSegment world_segments[V5_STATUS_SCENE_SEGMENT_COUNT];
    V5ProgramSceneWorldMarker base_markers[V5_STATUS_SCENE_MARKER_COUNT];
    ...
    V5ProgramSceneModel pose_model;
    V5ProgramScenePoseMatrix pose_matrix;
    V5ProgramSceneBounds static_bounds;
    V5ProgramSceneBounds pose_bounds;
    ...
    uint64_t point_traversal_count;
