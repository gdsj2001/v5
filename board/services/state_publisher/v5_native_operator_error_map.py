...
ALIAS_PRESENTATION = {
    ...
    "ALL_HOME_AXIS_X_CONFIG_INVALID": (
        "X轴回零配置无效", "X轴回零配置缺失或无效，本次全轴回零未开始运动",
        "保持机器停止，检查X轴从站、比例和零位参数，保存并彻底重启后重新回零"),
    "ALL_HOME_AXIS_Y_CONFIG_INVALID": (
        "Y轴回零配置无效", "Y轴回零配置缺失或无效，本次全轴回零未开始运动",
        "保持机器停止，检查Y轴从站、比例和零位参数，保存并彻底重启后重新回零"),
    "ALL_HOME_AXIS_Z_CONFIG_INVALID": (
        "Z轴回零配置无效", "Z轴回零配置缺失或无效，本次全轴回零未开始运动",
        "保持机器停止，检查Z轴从站、比例和零位参数，保存并彻底重启后重新回零"),
    "ALL_HOME_AXIS_A_CONFIG_INVALID": (
        "A轴回零配置无效", "A轴回零配置缺失或无效，本次全轴回零未开始运动",
        "保持机器停止，检查A轴从站、比例和零位参数，保存并彻底重启后重新回零"),
    "ALL_HOME_AXIS_B_CONFIG_INVALID": (
        "B轴回零配置无效", "B轴回零配置缺失或无效，本次全轴回零未开始运动",
        "保持机器停止，检查B轴从站、比例和零位参数，保存并彻底重启后重新回零"),
    "ALL_HOME_AXIS_C_CONFIG_INVALID": (
        "C轴回零配置无效", "C轴回零配置缺失或无效，本次全轴回零未开始运动",
        "保持机器停止，检查C轴从站、比例和零位参数，保存并彻底重启后重新回零"),
