...
from v5_wcs_status_codec import (
    ...
    WCS_AXIS_COUNT,
    WCS_COUNT,
    WCS_PARAM_AXIS_OFFSETS,
    WCS_PARAM_BASES,
    WCS_TABLE_VALUE_COUNT,
    WCS_VERSION,
    atomic_write,
    crc32_like,
    wcs_from_g5x,
...
def poll_once(
    ...
    paused_valid, paused_value = interpreter_paused_from_stat(stat, interpreter_paused_value)
    all_homed_valid, all_homed = all_homed_from_stat(stat)
    current_line_valid, current_line = line_from_stat(stat, 'current_line')
