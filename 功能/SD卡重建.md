...
detail_sections: [#sd-mainline, #sd-input-closure, #sd-boot-files, #sd-incremental-current, #sd-offline-certification, #sd-write-readback, #sd-board-acceptance, #sd-forbidden-detours]
<!-- AI_FAST_READ_END -->
...
<a id="sd-offline-certification"></a>
## 8. 断网空缓存全量认证
...
4. 必须用真实手指验证 FT5x26、`/dev/input/by-path/z20-touchscreen` 和正式校准 owner；模拟输入不能替代。
